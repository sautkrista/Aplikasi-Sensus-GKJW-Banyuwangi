...
@section('content')
  ...
  <div class="container">
    <div class=" card mb-3">
      ...
      <div class="card-body">
        <form method="POST" action="{{ route('data-warta.store') }}" enctype="multipart/form-data">
          @csrf
          <div class="row mb-3">
            <div class="col">
              <div class="form-group">
                ...
                <input id="minggu" type="week" class="form-control datepicker @error('minggu') is-invalid @enderror"
                  name="minggu" value="{{ old('minggu') }}" autofocus>
            ...
            <div class="col">
              <div class="form-group">
                ...
                <input id="halaman" type="text" class="form-control @error('halaman') is-invalid @enderror"
                  name="halaman" value="{{ old('halaman') }}" autocomplete="halaman" autofocus>
